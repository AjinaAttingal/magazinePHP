                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="topbar-info">
                                                <a href="tel:+61-3-8376-6284"><i class="fa fa-phone"></i>+91 8606475101</a>
                                                <span>/</span>
                                                <a href="mailto:support@libraria.com"><i class="fa fa-envelope"></i>aljoantony@essbeeinfotech.com</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <?php
                        ...
                        $mag_id = $_GET["mag_id"];
                            ...
                            $result=mysqli_query($conn,"SELECT * FROM magazine Where mag_id=".$mag_id);?>
                           <?php $cnt=1;
...
<!--                            </div>-->
                        ...
                        <div class="product-info mt-15 text-center" >
                                ...
                                <p><?php  echo "<a href='pdf.php'><iframe  src='Admin/img/Files/".$user_data['mag_file']."' height='1000' width='1500px'></iframe>" ?></p>
