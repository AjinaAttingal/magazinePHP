            ...
            if(empty($_POST['d_id'])||empty($_POST['d_name'])||empty($_POST['d_email'])||empty($_POST['d_password']))
                  { 
                      $error = '<div class="alert alert-danger alert-dismissible fade show">
                                  ...
                                  <strong style="margin-left:40px;">All fields Must be Fillup!</strong>
                                </div>';   
                }
                else
                    {
                      $fname = $_FILES['upload_file']['name'];
                              ...
                              $store = "../Upload/image/".basename($fnew);                    
                ...
                if($fsize>=100000000)
                    {
                      $error =  '<div class="alert alert-danger alert-dismissible fade show">
                                ...
                                <strong style="margin-left:40px;">Max Image Size is 1024kb!</strong> Try different Image.
                              </div>';
                }
                else
                    {                    
                      $sql = "INSERT INTO dashboard(upload_file,d_id,d_name,d_email,d_password) VALUE('".$fnew."','".$_POST['dash_admin_id']."','".$_POST['dash_name']."','".$_POST['dash_email']."','".$_POST['dash_password']."')";  // store the submited data ino the database :images
                        mysqli_query($conn, $sql); 
                        move_uploaded_file($temp, $store);
        
                      $success =  '<div class="alert alert-success alert-dismissible fade show">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                 <strong style="margin-left:40px;">New Product Added Successfully.</strong>
                              </div>';
                    }
              }
              elseif($extension == '')
                    {
                      $error =  '<div class="alert alert-danger alert-dismissible fade show">
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                          <strong style="margin-left:40px;">select image</strong>
                                        </div>';
                }
                else
                    {
            ...
            <center>
                <div class="box1" style="margin-top: 70px;">
                    ...
                    <div>
                        ...
                        <div>
                            <img src="./Upload/image/<?php echo $data['dash_image']; ?>">
                            <?php
                        ...
                        <input type="text" name="d_id" placeholder="Admin Id">
                        <input type="text" name="d_name" placeholder="User Name">
                        <input type="text" name="d_email" placeholder="E-mail Id">
                        <input type="text" name="d_password" placeholder="password">
