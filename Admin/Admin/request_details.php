    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.php"><img src="assets/images/logo.png" alt="logo" / style="width: 150px; height: 60px;"></a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Requesting Details</h4>
                      ...
                      <?php
                        ...
                        if(!mysqli_num_rows($query) > 0 )
                          ...
                          {       
                            ...
                            {
                             echo ' <tr><td>'.$rows['rd_id'].'</td>
                                    <td>'.$rows['rd_name'].'</td>
                                    <td>'.$rows['rd_email'].'</td>
                                    <td>'.$rows['rd_message'].'</td>
                                    <td><a href="delete_request_details.php?rd_del='.$rows['rd_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
