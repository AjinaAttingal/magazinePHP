...
<html lang="en">
  ...
  if(isset($_POST['submit']))          
      { 
          if(empty($_POST['pro_name'])||empty($_POST['pro_desc'])||empty($_POST['pro_price'])||empty($_POST['sub_category_name']))
                  { 
                ...
                else
                    {
                      $fname = $_FILES['pro_image']['name'];
                              $temp = $_FILES['pro_image']['tmp_name'];
                              $fsize = $_FILES['pro_image']['size'];
                              $extension = explode('.',$fname);
                              $extension = strtolower(end($extension));  
                              $fnew = uniqid().'.'.$extension;
                              $store = "../Upload/Product/".basename($fnew);                    
            if($extension == 'jpg'||$extension == 'png'||$extension == 'gif' )
              {        
                if($fsize>=100000000)
                    ...
                    {                    
                      $sql = "INSERT INTO product(subcat_id,prod_name,prod_desc,prod_price,prod_image) VALUE('".$_POST['sub_category_name']."','".$_POST['pro_name']."','".$_POST['pro_desc']."','".$_POST['pro_price']."','".$fnew."')";  // store the submited data ino the database :images
                          ...
                          <div class="row p-t-20">
                            ...
                            <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input type="text" name="pro_desc" class="form-control form-control-danger" >
                              </div>
                            </div>
                          </div>        
                          <div class="row p-t-20">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="pro_price" class="form-control" placeholder="Rs">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Image</label>
                                <input type="file" name="pro_image"  id="lastName" class="form-control form-control-danger" placeholder="12n">
                              </div>
                            </div>
                          </div>
                           <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <select name="sub_category_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                  <option>--Select Category--</option>
                                  <?php $ssql ="select * from sub_category";
