    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/b2.png" alt="logo" / style="width: 30px;"><span style="color: white; margin-left: 20px;">Nursery</span></a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="category.html">Add Category</a></li>
                <li class="nav-item"> <a class="nav-link" href="add_sub_category.html">Add Sub Category</a></li>
              </ul>
            </div>
          </li>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/b2.png" alt="">
              ...
              <div class="col-lg-12">
                <div class="card card-outline-primary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-body">
                      <?php $sql ="select * from category where category_id='$_GET[cat_upd]'";
                        ...
                        <div class="row p-t-20">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="category_name" value="<?php echo $row['category_name'];  ?>" class="form-control" placeholder="Category Name">
                            </div>
                          </div>
                        </div>
